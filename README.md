...
Previously: Expedia Group · Barclays · Musafir.com  
Open to new grad SWE roles · [LinkedIn](https://linkedin.com/in/vraj-rajpura) · [Portfolio](https://vrajrajpura.github.io/Vraj_portfolio_website/)
...
**AI & agents**  
Claude Code · Claude API · OpenAI API · LangChain · Agentic orchestration  
RAG pipelines · Prompt engineering · Token optimization · Multi-agent systems · Groq

**Full-stack**  
Next.js · React · TypeScript · FastAPI · Flask · Node.js · REST APIs

**Cloud & infra**  
GCP · AWS (Lambda, EC2, S3, SQS, VPC) · Azure (ML Studio, Cognitive Services)  
Docker · Kubernetes · CI/CD · Spinnaker · Vault · Terraform
...
Core Python data visualization library.
